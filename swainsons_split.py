...
#outFile=open("/Users/Rachael/Documents/MigratoryBirds/Swainsons/Demography/output/island_splitb.txt","w")
nuC_init=1
nuI_init=1
m12_init=0.1
m21_init=0.1
...
dd = dadi.Misc.make_data_dict('/Users/Rachael/Documents/MigratoryBirds/Swainsons/Demography/formatdata/allsnps_dadi.txt')
...
func = swainsons_models.split_migration
...
p0 = dadi.Misc.perturb_params(params, fold=0, lower_bound=lower_bound, upper_bound=upper_bound)
